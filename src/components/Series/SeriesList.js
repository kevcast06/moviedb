    ...
    return (
      <div className="post_content" >
        <div>
          ...
          <img src={"https://image.tmdb.org/t/p/w500"+serie.poster_path} className='img_poster' alt="poster"/>
        </div>
        <div className="post_info">

          <div className="info-box">
            <div className="info-item">
              <div className='title'>{serie.original_name}</div> <div>{serie.popularity}</div>
            </div>


            <div className="info-item">
              <p className='title subtitles'></p><p  className='subtitles'>|</p> <p  className='subtitles'>{serie.first_air_date}</p> <p  className='subtitles'>|</p> <p className='subtitles'>{serie.genre_ids}</p>
            </div>
